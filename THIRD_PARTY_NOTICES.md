...
This project is an unofficial, independently developed modification installer for systems on which DVSwitch is already installed.

DVSwitch, DVSwitch Dashboard, MMDVM_Bridge, P25Gateway, NXDNGateway, YSFGateway, Analog_Bridge, and related components are not included in this repository. They remain the property of their respective copyright holders and are governed by their respective licenses and permissions.

Official project resources:

- https://dvswitch.org/
- https://github.com/DVSwitch
