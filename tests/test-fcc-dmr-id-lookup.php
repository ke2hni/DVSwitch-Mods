...
requireSame('---', dvsModsFccFirstName('K1DUP'), 'conflicting duplicate DMR names were accepted');
requireSame('---', dvsModsFccFirstName('K1BAD'), 'Unknown placeholder was accepted');
requireSame('---', dvsModsFccFirstName('K2BAD'), 'dash placeholder was accepted');
requireSame('---', dvsModsFccFirstName('K3BAD'), 'numeric garbage was accepted');
